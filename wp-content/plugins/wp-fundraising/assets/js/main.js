    ...
    jQuery('.xs-countdown-timer[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            var $this = jQuery(this).html(event.strftime(' ' +
                '<span class="timer-count">%-D <span class="timer-text">أيام</span></span>  ' +
                '<span class="timer-count">%H <span class="timer-text">ساعات</span></span> ' +
                '<span class="timer-count">%M <span class="timer-text">دقائق</span></span> ' +
                '<span class="timer-count">%S <span class="timer-text">ثواني</span></span>'));
        });
    });
